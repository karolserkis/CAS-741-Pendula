...
(For example the number of pendulums cannot exceed the boundary of the
...
a constraint on the number of pendulums possible to be displayed 
in the simulation.
...
\begin{table}[!htb]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        \rref{funkinpot} & X & X & X & X & X\\ \hline
