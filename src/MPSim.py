## CAS 741 - Development of Scientific Computing Software - Karol Serkis
## Reference source code: 
## https://github.com/farzadab/pendulum_simulation
## Python implementation of multiple pendula simulation using OpenGL GLUT 
...
# ------------------------------------------------------------------------
# Input commandline option - parse args
# ------------------------------------------------------------------------
...
if (args.nlinks > 5):
	print("The maximum number of pendula is 5")
	nLinks = 5
elif (args.nlinks < 1):
	print("The minimum number of pendula is 1")
	nLinks = 1
else:
	nLinks = args.nlinks
...
KGd = args.gsp
if args.groundplane:
        groundPlane = 0.01  # I couldn't make the ground opaque, so I'm setting the ground to be a little bit higher
else:
        groundPlane = -10e10
...
def main():
        ...
        window = glutCreateWindow("CAS 741 - Multi-Pendulum Simulation")
...
def DrawCube():
	...
	glScalef(0.21,0.5,0.5);                  # dimensions below are for a 2x2x2 cube, so scale it down by a half first
